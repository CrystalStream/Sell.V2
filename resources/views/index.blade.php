...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <div class="main-bar">
        <p class="hidden-xs hidden-sm main-bar__p">Estas loggeado como:
            ...
            <span class="pull-right pr">Se empezo caja con: <span class="user_loggedin">$320</span></span></p>        
        <span class="pl hidden-md hidden-lg user_loggedin">@usuario<span class="pl">caja chica: $320</span>
    </div>
